 ...
 */
final class Version20200415172615 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD alliance_id INT DEFAULT NULL, CHANGE serveur_id serveur_id INT DEFAULT NULL, CHANGE roles roles JSON NOT NULL, CHANGE username username VARCHAR(255) DEFAULT NULL, CHANGE peuple peuple VARCHAR(255) DEFAULT NULL');
