 ...
 */
final class Version20200330171501 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE serveur_user_peuple (id INT AUTO_INCREMENT NOT NULL, serveur_id INT NOT NULL, user_id INT NOT NULL, peuple VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, INDEX IDX_AC8B9EF0B8F06499 (serveur_id), INDEX IDX_AC8B9EF0A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
