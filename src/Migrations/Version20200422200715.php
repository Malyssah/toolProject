 ...
 */
final class Version20200422200715 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE alliance ADD chef_alliance VARCHAR(255) DEFAULT NULL, CHANGE serveur_id serveur_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE alliance DROP chef_alliance, CHANGE serveur_id serveur_id INT DEFAULT NULL');
